...
describe('Part 1', () => {
    it('should pass the example', async () => {
        expect(part1(await inputExample)).toBe(150);
    })
    it('should pass the input', async() => {
        expect(part1(await input)).toBe(1694130);
    })
})

describe('Part 2', () => {
    it('should pass the example', async () => {
        expect(part2(await inputExample)).toBe(900);
    })
    it('should pass the input', async() => {
        expect(part2(await input)).toBe(1698850445);
    })
})